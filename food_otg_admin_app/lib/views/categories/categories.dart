...
import 'package:food_otg_admin_app/views/categories/add_categories.dart';
import 'package:food_otg_admin_app/views/categories/edit_category_screen.dart';
...
class _CategoriesScreenState extends State<CategoriesScreen> {
  ...
  Stream<List<DocumentSnapshot>> _categoryStreamData() {
    Query query = FirebaseDatabaseServices().allCategoriesList;
