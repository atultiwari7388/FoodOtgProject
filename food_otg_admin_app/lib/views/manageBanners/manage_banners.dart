...
import 'package:food_otg_admin_app/views/manageBanners/add_banner.dart';
import 'package:food_otg_admin_app/views/manageBanners/edit_banner.dart';
...
class _ManageBannersState extends State<ManageBanners> {
  ...
  Stream<List<DocumentSnapshot>> _bannersStreamData() {
    Query query = FirebaseDatabaseServices().allBannerList;
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                      style:
                          ElevatedButton.styleFrom(backgroundColor: kDarkGray),
