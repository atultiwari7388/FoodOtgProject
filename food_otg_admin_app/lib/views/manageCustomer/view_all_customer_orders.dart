...
class ViewAllCustomersOrders extends StatefulWidget {
  const ViewAllCustomersOrders(
  ...
  @override
  State<ViewAllCustomersOrders> createState() => _ViewAllCustomersOrdersState();
}

class _ViewAllCustomersOrdersState extends State<ViewAllCustomersOrders> {
  // bool isLoading = true;
