...
import 'package:food_otg_admin_app/views/manageCustomer/view_all_customer_orders.dart';
...
class ManageCustomersScreen extends StatefulWidget {
  static const String id = "manage_customer_screen";
...
class _ManageCustomersScreenState extends State<ManageCustomersScreen> {
  ...
  late Stream<List<DocumentSnapshot>> _customerStream;
  int _perPage = 10;
  int _currentPage = 0;
  ...
  void initState() {
    super.initState();
    _customerStream = _customerStreamData();
  }

  Stream<List<DocumentSnapshot>> _customerStreamData() {
    Query query = FirebaseDatabaseServices().allCustomersList;
        ...
        child: Column(
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: IconButton(
                  ...
                  onPressed: () {
                    ...
                    setState(() {
                      _customerStream =
                          _customerStreamData(); // Update the stream
                    });
                  },
                ),
              ),
              onChanged: (value) {
                setState(() {
                  _customerStream = _customerStreamData(); // Update the stream
                });
              },
            ),
            SizedBox(height: 30),
            buildHeadingRowWidgets(
                "Sr.no.", "C'Name", "Phone", "Email", "Action"),
                    ...
                    children: [
                      ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          log("User name: " + driverName.toString());
  ...
  Widget buildHeadingRowWidgets(srNum, driverName, phone, email, action) {
    return Container(
      padding:
          ...
          Row(
            children: [
              ...
              Expanded(
                flex: 1,
                child: TextButton(
                  onPressed: () => Get.to(() => ViewAllCustomersOrders(
                      userId: userId, userName: driverName)),
  ...
  Widget buildTableCell(String text, DocumentSnapshot data) {
    ...
    return TableCell(
      child: GestureDetector(
        onTap: () {
          Get.to(() => ViewAllCustomersOrders(
              userId: driverData["uid"], userName: driverData["userName"]));
        },
        child: Padding(
          padding: const EdgeInsets.all(8.0),
          child: Text(
