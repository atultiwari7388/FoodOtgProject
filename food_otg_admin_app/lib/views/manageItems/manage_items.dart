...
import 'package:food_otg_admin_app/views/manageItems/add_items_screen.dart';
import 'package:food_otg_admin_app/views/manageItems/edit_item_screen.dart';
...
class _ManageItemsScreenState extends State<ManageItemsScreen> {
  ...
  Stream<List<DocumentSnapshot>> _getItemsStream() {
    Query query = FirebaseDatabaseServices().allItemsList;
