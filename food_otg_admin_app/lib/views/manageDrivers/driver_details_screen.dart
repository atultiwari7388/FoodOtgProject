...
import 'package:food_otg_admin_app/views/manageDrivers/all_drivers_bookings.dart';
import 'package:get/get.dart';
import 'package:intl/intl.dart';
import '../../constants/constants.dart'; // For web-based file downloading

class DriversDetailScreen extends StatefulWidget {
  final DocumentSnapshot riderData;

  const DriversDetailScreen({super.key, required this.riderData});

  @override
  State<DriversDetailScreen> createState() => _DriversDetailScreenState();
}

class _DriversDetailScreenState extends State<DriversDetailScreen> {
