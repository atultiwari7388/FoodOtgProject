...
//   static const String id = "manage_drivers_screen";
...
//     Query query = FirebaseDatabaseServices().allDriversList;
...
//                           return InkWell(
//                             onTap: () => Get.to(() => DriversDetailScreen(
  ...
  Widget buildTableCell(String text, DocumentSnapshot data) {
    return TableCell(
      child: GestureDetector(
        onTap: () {
          Get.to(() => DriversDetailScreen(riderData: data));
        },
        child: Padding(
          padding: const EdgeInsets.all(8.0),
          child: Text(
