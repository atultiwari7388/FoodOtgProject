...
import 'package:food_otg_admin_app/views/manageCoupons/add_coupons.dart';
import 'package:food_otg_admin_app/views/manageCoupons/edit_coupon.dart';
...
class _ManageCouponsScreenState extends State<ManageCouponsScreen> {
  ...
  Stream<List<DocumentSnapshot>> _couponStreamData() {
    Query query = FirebaseDatabaseServices().allCouponsList;
