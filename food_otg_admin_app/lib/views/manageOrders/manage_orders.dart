...
import 'package:food_otg_admin_app/services/firebase_database_services.dart';
import 'package:food_otg_admin_app/utils/appStyle.dart';
import 'package:food_otg_admin_app/utils/toast_msg.dart';
import 'package:food_otg_admin_app/views/manageOrders/orders_details_screen.dart';
...
class _ManageOrdersScreenState extends State<ManageOrdersScreen> {
  ...
  Stream<List<DocumentSnapshot>> _getOrdersStream() {
    Query query = FirebaseDatabaseServices().allOrdersList;
