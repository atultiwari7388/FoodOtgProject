                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Row(
                                  children: [
                                    Icon(Icons.receipt_long, color: kSecondary),
                                    SizedBox(width: 8),
                                    Column(
                                      crossAxisAlignment:
...
// import '../services/collection_refrences.dart'; // Add this import
...
//     // Create a combined stream of both cart and history subcollections
//     Stream<QuerySnapshot> cartStream = userRef.collection('cart').snapshots();
//     Stream<QuerySnapshot> historyStream =
//         userRef.collection('history').snapshots();

//     return CombineLatestStream.combine2(cartStream, historyStream,
//         (cartSnapshot, historySnapshot) {
//       int cartItemCount = cartSnapshot.docs.length;
...
//         DocumentSnapshot nextOrder = filteredHistoryDocs.first;
//         data['orderId'] = nextOrder.id;
//         data['orderStatus'] = nextOrder['status'];
//       }
...
//         int cartItemCount = snapshot.data!['cartItemCount'];
//         bool hasHistory = snapshot.data!['hasHistory'];
//         String? orderId = snapshot.data!['orderId'];
//         dynamic orderStatus = snapshot.data!['orderStatus'];
//         String orderStatusString = AppServices().getStatusString(orderStatus);
...
//       CollectionReference historyRef = userRef.collection('history');
...
//       // Filter out history items with status 5 (delivered) or -1 (canceled)
//       List<DocumentSnapshot> filteredHistoryDocs = historyDocs.where((doc) {
//         int status = doc['status'];
//         return status != 5 && status != -1;
//       }).toList();
