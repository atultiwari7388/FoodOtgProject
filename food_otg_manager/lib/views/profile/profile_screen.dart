...
import 'package:food_otg_manager/views/items/add_items.dart';
import 'package:food_otg_manager/views/items/items_screen.dart';
import 'package:food_otg_manager/views/notificationSetting/notification_setting.dart';
import 'package:food_otg_manager/views/orderHistory/order_history_screen.dart';
import 'package:food_otg_manager/views/profile/profile_details_screen.dart';
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            SizedBox(width: 5.w),
                            Container(
                                width: 30.w, height: 3.h, color: kDark),
                          ],
                        ),
