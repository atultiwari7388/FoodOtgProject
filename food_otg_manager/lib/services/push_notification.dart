...
// on tap local notification in foreground
  ...
  Future updateUserFCMToken(String userId, String fcmToken) async {
    _firestore.collection('Managers').doc(userId).update({
      'fcmToken': fcmToken,
    }).then((_) {
      log('FCM token updated in managers collection');
    }).catchError((error) {
      log('Error updating FCM token in managers collection: $error');
    });
  }
}
